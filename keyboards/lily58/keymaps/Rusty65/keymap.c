...
bool oled_task_user(void) {
  if (is_keyboard_master()) {
    ...
    oled_write(strcat("WPM:",get_u8_str(get_current_wpm(), '0')), false);
  } else {
    ...
    oled_write(strcat("WPM:",get_u8_str(get_current_wpm(), '0')), false);                      // writes wpm on top left corner of string
  }
    return false;
}
#endif // OLED_ENABLE
