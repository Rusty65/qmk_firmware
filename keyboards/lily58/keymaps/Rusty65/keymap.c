 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
    ...
    KC_LSFT,    KC_Z,       KC_X,       KC_C,       KC_V,   KC_B,       TD(TD_VOLD_PV),    TD(TD_VOLU_NX),    KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_EQL, \
                                        KC_UP,      KC_DOWN,    MO(_SYMBOLS),MO(_NUMBERS),LT(_SYMBOLS,KC_SPC),MO(_NUMBERS),KC_LEFT,    KC_RGHT
),
/* SYMBOLS
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 ...
 */
 ...
 [_NUMBERS] = LAYOUT( \
    ...
    PIPE,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  _______,  KC_MUTE, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  XXXXXXX, XXXXXXX, \
